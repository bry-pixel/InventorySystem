...
<div class="panel panel-default shadow-sm" style="border-radius:10px; width: 60%; margin: auto; margin-top: 30px;">
  ...
  <div class="panel-body p-4">
    <form method="post" action="edit_product.php?id=<?php echo (int)$product['id']; ?>" class="clearfix">
      ...
      <div class="form-group text-end mt-3" style="margin-top:20px; gap:10px;">
        <a type="button" href="admin.php" class="btn btn-secondary">
