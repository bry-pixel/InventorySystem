    ...
    <div class="panel panel-default shadow-sm">
      ...
      <div class="panel-heading d-flex justify-content-between align-items-center" 
        ...
        <div class="pull-right">
          <button onclick="openModal('add_purchase.php')" 
              ...
              <tr>
                ...
                <td class="text-center">
                  <?php if ($purchase['status'] == 'Pending'): ?>
                    <a href="purchases.php?receive_id=<?= (int)$purchase['id']; ?>&status=<?= $status; ?>" 
                       class="btn btn-success btn-xs" 
                       onclick="return confirm('Mark this purchase as Received?');">Receive</a>
                    <a href="purchases.php?cancel_id=<?= (int)$purchase['id']; ?>&status=<?= $status; ?>" 
                       class="btn btn-danger btn-xs" 
                       onclick="return confirm('Cancel this purchase?');">Cancel</a>
                  <?php else: ?>
