                ...
                <?php foreach ($transactions as $t): ?>
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <a class="btn btn-warning btn-xs" onclick="loadModal('edit_transaction.php?id=<?= (int)$t['txn_id']; ?>')">
                        <span class="glyphicon glyphicon-edit"></span> Edit
                      </a>
                      <a class="btn btn-danger btn-xs" href="delete_transaction.php?id=<?= (int)$t['txn_id']; ?>" onclick="return confirm('Delete this transaction?');">
                        <span class="glyphicon glyphicon-trash"></span> Delete
                      </a>
                      <a class="btn btn-success btn-xs" target="_blank" href="reciept.php?id=<?= (int)$t['txn_id']; ?>">
...
(function(){
  ...
  window.loadModal = function(url) {
    openModal();
    modalBody.innerHTML = `<div style="text-align:center; padding:28px;">
      <svg width="40" height="40" viewBox="0 0 50 50">
        <path fill="#0d6efd" d="M43.935,25.145c0-10.318-8.372-18.69-18.69-18.69S6.554,14.827,6.554,25.145h4.068
        c0-8.066,6.556-14.622,14.568-14.622s14.568,6.556,14.568,14.622H43.935z">
        <animateTransform attributeType="xml" attributeName="transform" type="rotate"
        from="0 25 25" to="360 25 25" dur="1s" repeatCount="indefinite"/></path>
      </svg>
    </div>`;
